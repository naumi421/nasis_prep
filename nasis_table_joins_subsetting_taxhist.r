...
taxhist$taxonnameh = taxhist$taxonname
taxhist$taxclnameh = taxhist$taxclname
taxhist$taxclname_sh = taxhist$taxclname_s
...
seriestabs = subset(seriestab, select = c(soilseriesname,order,subord,subgrp,grtgrp_nm,pscs))
...
nasispedonsjn_spodic = subset(nasispedonsjn, nasispedonsjn$order != "NULL", select = c(pid, upedonid, xwgs84, ywgs84, spodic))
